  ...
  <div id="Directions">
    <div class="grid grid-cols-12 mt-4 shadow-md">
      ...
      <div class="col-span-10 pr-4">
        ...
        <div class="mb-2 mt-5">
          <AutoCompleteInput theId="firstInput" v-model:input="pickup" placeholder="Enter Pick-Up Location" @isActive="isPickupActive = true" />
        </div>

        <div class="mb-3">
          <AutoCompleteInput theId="secondInput" v-model:input="destination" placeholder="Where to?" @isActive="isPickupActive = false" />
        </div>
      </div>
    </div>
    ...
    <div class="flex items-center custom-border-bottom">
      ...
      <div>
        <div class="text-lg text-gray-600">Los Angeles, CA</div>
        <div class="text-lg text-gray-400">United States</div>
      </div>
    </div>
  </div>
</template>
